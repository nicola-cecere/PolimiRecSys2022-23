 ...
 * Come WithLength ma se la lunghezza è sconosciuta non attribuiamo bonus
 */
public class WithKnownLength extends ScoreComputer{
    public WithKnownLength(List<Interaction> interactions, List<Item> items) {
