...
from RecSys2022.Recommenders.BaseMatrixFactorizationRecommender import BaseMatrixFactorizationRecommender
from RecSys2022.Recommenders.Incremental_Training_Early_Stopping import Incremental_Training_Early_Stopping
from RecSys2022.Recommenders.Recommender_utils import check_matrix
...
class _MatrixFactorization_Cython(BaseMatrixFactorizationRecommender, Incremental_Training_Early_Stopping):
    ...
    def fit(self, epochs=300, batch_size = 1000,
        ...
        from RecSys2022.Recommenders.MatrixFactorization.Cython.MatrixFactorization_Cython_Epoch import MatrixFactorization_Cython_Epoch
